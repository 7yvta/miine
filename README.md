...
- `loader.lua` does direct text replacements in script source before execution (no auto-translate hook loop).
...
- no global translation hooks (lower lag/FPS impact).
